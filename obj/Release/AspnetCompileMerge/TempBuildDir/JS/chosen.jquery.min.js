...
!function () {
    ...
    AbstractChosen = function () {
        ...
        return AbstractChosen.prototype.set_default_values = function () {
            ...
            this.search_contains = true || !1,//2016-10-25  刘玉京修改 这里是实现下拉列表的 全局模糊匹配 默认是在第一位匹配【this.options.search_contains】  改成true是全局匹配
        ...
        AbstractChosen.prototype.container_width = function (obj) {
            ...
            objwidth = obj.style.width + "";//.replace("px", "")//.replace("%", "");//---2016-10-25  刘玉京修改此方法  修改了由于嵌套导致宽度为0的bug
            //} else {

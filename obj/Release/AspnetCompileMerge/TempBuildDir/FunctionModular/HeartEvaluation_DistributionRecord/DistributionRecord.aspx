<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DistributionRecord.aspx.cs" Inherits="CrisisInterfere.FunctionModular.HeartEvaluation_DistributionRecord.DistributionRecord1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPages" runat="server">
    ...
    <div id="content pr">
        <div class="row" style="margin-left: 9px; margin-bottom: 20px;">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12" style="margin-top: 5px;">
                ...
                <input id="Department_ID" placeholder="--选择部门--" class="form-control" name="ADepartment" style="top: 0; height: 20px;" />
            </div>
            ...
            <div class="col-md-1 col-sm-12 col-xs-12" style="margin-top: 5px; text-align: right;">
                <button id="go_search" class="btn btn-or w_radiusbtn-sm" name="QX_SelectDistributionRecord"><i class="fa fa-search "></i>查询</button>
            </div>
        </div>
        ...
        <div class="row" style="margin-left: 9px; margin-bottom: 20px;">
            <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="tableGrid">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 10px">
                                    <input id="allCheck" onclick="AllCheck()" type="checkbox" />
                                </th>
                ...
                <button class="btn btn-or w_radius" name="QX_BulkRemindByWebLetter" onclick="BulkRemindByWebLetter()"><i class="icon iconfont">&#xebd9;</i> 批量提醒</button>
                <button class="btn btn-or w_radius ml10" onclick="BulkDelete()" name="QX_BulkDelete"><i class="icon iconfont">&#xeb8d;</i> 批量删除</button>
            </div>
        </div>
        <!--多个提醒-->
                ...
                <div class="modal-content" style="margin-top: 35%; width: 60%; height: 200px; margin-left: 120px;">
                    ...
                    <div class="row" style="margin-top: 80px;">
                        <div class="col-sm-6  col-xs-6 text-right">
                            <button onclick="tixin()" type="button" class="btn btn-sm" style="border-color: orange; color: white">确定</button>
                        </div>
                ...
                <div class="modal-content" style="margin-top: 35%; width: 79%; height: 200px;">
                    ...
                    <div class="row" style="margin-top: 88px;">
                        <div class="col-sm-5  col-xs-6 text-right">
                            <button onclick="Remind()" type="button" class="btn btn-sm" style="border-color: orange; color: white">确定</button>
                        </div>
                        <div class="col-sm-4  col-xs-3  text-right">
                            <button type="button" class="btn btn-sm singleCancel" data-dismiss="modal" >取消</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).on("click", "[data-name=remind]", function () {
            $('#sinWebLetter')[0].checked = false;
            $('#sinEmail')[0].checked = false;
        ...
        $(document).on("click", "[data-name=remove]", function () {
            ...
            var named = $(this).parent().parent().find('td').eq(8).text();

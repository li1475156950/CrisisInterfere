<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="LetterList_old.aspx.cs" Inherits="CrisisInterfere.FunctionModular.Letter.LetterList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPages" runat="server">
    ...
    <div class="row" style="text-align: right; padding-bottom: 20px">
        <button class="btn  btn-sm" onclick="NewInfoClick()" style="border: 1px solid orange; color: orange">+新增信息</button>
    </div>
    <!-- /. ROW  -->
    <div class="row">
                ...
                <div class="tab-pane fade active in" id="home">
                    ...
                    <div class="row">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <button class="btn btn-danger btn-sm" style="margin-left: 20px;" onclick="updatedeletes()"><i class="glyphicon glyphicon-trash"></i>批量删除</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        */
        ...
        function NewInfoClick() {
            ...
            $('[class=filter-option pull-left]span').val('请选择');

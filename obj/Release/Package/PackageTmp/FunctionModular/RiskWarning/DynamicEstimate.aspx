<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DynamicEstimate.aspx.cs" Inherits="CrisisInterfere.FunctionModular.RiskWarning.DynamicEstimate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPages" runat="server">
    ...
    <div class="content">
        ...
        <div class="row" style="margin-left: 0px; margin-bottom: 20px;">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12" style="margin-top: 5px; margin-left: -15px;">
                <input id="departmentName" class="form-control" placeholder="部门名称">
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12" style="margin-top: 5px; margin-left: -15px;">
                ...
                <div class="col-md-5 col-sm-5 col-xs-5" style="padding-right: 0px; padding-left: 0px;">
                    <input size="16" type="text" id="datetimeStart" readonly onclick="javascript: $(this).val('')" class="form-control form_datetime" placeholder="开始日期" autocomplete="off"/>
                </div>
                <div class="col-md-1 col-sm-2 col-xs-2" style="padding-left: 8px">
                    <label style="height: 34px; line-height: 34px;">-</label>
                </div>
                <div class="col-md-5 col-sm-5 col-xs-5 " style="padding-right: 0px; padding-left: 0px;">
                    <input size="16" type="text" id="datetimeEnd" readonly onclick="javascript: $(this).val('')" class="form-control form_datetime" placeholder="结束日期" autocomplete="off"/>
                </div>
    ...
    <!-- 新建评估弹窗 -->
    <div class="modal fade x_xjzh in" id ="showMemberModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top: 50%; width: 100%">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group  text-right" style="margin-top: 20px">
                            ...
                            <span style="float: left; color: #a94442; display: none; margin-left: 0px;" name="tip">请选择需要评估的成员!</span>
                        </div>
                    </div>
 ...
 var navName = '/FunctionModular/RiskWarning/DynamicEstimate.aspx';
        ...
        $('#showMemberModal').on('shown.bs.modal', function () {
            $("#needEstimateLoginName").val('');
            if ($(".filter-option").text() != '--请选择成员--') {
                $(".filter-option").text('--请选择成员--');
            }
        })
        ...
        $(document).on("click", ".bulkExportExcel", function () {
            var url = "Ajax/DynamicEstimate.ashx?operationType=BulkExportExcel";

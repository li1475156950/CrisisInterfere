...
namespace CrisisInterfere.FunctionService {
    ...
    public partial class FunctionEntity : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        public int Fun_Sort {
            get {
                return this.Fun_SortField;
            }
            set {
                if ((this.Fun_SortField.Equals(value) != true)) {
                    this.Fun_SortField = value;
                    this.RaisePropertyChanged("Fun_Sort");
                }
            }
        }
    ...
    public interface IFunctionService {
        ...
        System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetAllFun();
        ...
        System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetFunByFunType(int funType);
        ...
        System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetFunByParentID(int parentID);
        ...
        System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetAdminFunByUserID(int userID);
        ...
        CrisisInterfere.FunctionService.FunctionEntity GetParentFunByFunID(int funID);
        ...
        CrisisInterfere.FunctionService.FunctionEntity GetEntity(int Fun_ID);
        ...
        System.Collections.Generic.List<CrisisInterfere.FunctionService.RF_Entity> GetRF_AD();
        ...
        System.Collections.Generic.List<CrisisInterfere.FunctionService.RF_Entity> GetRoleAndFunctionByRoleID(int RoleID);
        ...
        System.Collections.Generic.List<CrisisInterfere.FunctionService.RoleEntity> SelectRoleName(string role_type);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IFunctionServiceChannel : CrisisInterfere.FunctionService.IFunctionService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FunctionServiceClient : System.ServiceModel.ClientBase<CrisisInterfere.FunctionService.IFunctionService>, CrisisInterfere.FunctionService.IFunctionService {
        ...
        public System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetAllFun() {
        ...
        public System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetFunByFunType(int funType) {
            return base.Channel.GetFunByFunType(funType);
        }
        
        public System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetFunByParentID(int parentID) {
            return base.Channel.GetFunByParentID(parentID);
        }
        
        public System.Collections.Generic.List<CrisisInterfere.FunctionService.FunctionEntity> GetAdminFunByUserID(int userID) {
            return base.Channel.GetAdminFunByUserID(userID);
        }
        
        public CrisisInterfere.FunctionService.FunctionEntity GetParentFunByFunID(int funID) {
            return base.Channel.GetParentFunByFunID(funID);
        }
        
        public CrisisInterfere.FunctionService.FunctionEntity GetEntity(int Fun_ID) {
            return base.Channel.GetEntity(Fun_ID);
        }
        
        public System.Collections.Generic.List<CrisisInterfere.FunctionService.RF_Entity> GetRF_AD() {
            return base.Channel.GetRF_AD();
        }
        
        public System.Collections.Generic.List<CrisisInterfere.FunctionService.RF_Entity> GetRoleAndFunctionByRoleID(int RoleID) {
            return base.Channel.GetRoleAndFunctionByRoleID(RoleID);
        }
        
        public System.Collections.Generic.List<CrisisInterfere.FunctionService.RoleEntity> SelectRoleName(string role_type) {

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="PersonalInfo_old.aspx.cs" Inherits="CrisisInterfere.FunctionModular.PersonalInfo.PersonalInfo" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-12 col-xs-12 col-md-offset-1">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <div class="form-group lb-panel-right pull-right">
                                            <textarea name="memberDescribe" class="form-control"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-10 col-sm-12 col-xs-12 col-md-offset-1" id="Div_U_Consult" style="display: none; margin-top: 10px;">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <div class="form-group lb-panel-right pull-right">
                                            <textarea class="form-control" id="U_Consult" name="U_Consult" maxlength="30"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-10 col-sm-12 col-xs-12 col-md-offset-1" id="Div_GoodField" style="display: none; margin-top: 10px;">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <div class="form-group lb-panel-right pull-right">
                                            <textarea class="form-control" id="GoodField" name="GoodField" maxlength="30"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="IdioctoniaEstimate.aspx.cs" Inherits="CrisisInterfere.FunctionModular.RiskWarning.IdioctoniaEstimate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPages" runat="server">
    ...
    <div class="content">
        ...
        <div class="row" style="margin-left: 0px; margin-bottom: 20px;">
            <div class="col-md-12 nopl">
                ...
                <%--<button class="btn btn-or w_radius ml10" data-mark="addDiscernEstimate"><i class="icon iconfont">&#xebec;</i> 添加鉴别评估</button>--%>
            </div>
        </div>
        <!-- main结束 -->
    </div>
    ...
    <script type="text/javascript">
        ...
        function InitTable() {
            ...
            tableGrid = $('#tableGrid').dataTable({
                ...
                createdRow: function (row, data, dataIndex) {
                    $('td:eq(1)', row).html(" <input class='childCheck'  type=\"checkbox\" name='CheckboxID' data-belongToCode ='" + data[12] +
                        "' value=\"" + data[0] + "\" />");
                    $('td:eq(0)', row).hide();
                    var operation = "";
                    operation =
                   " <button  class='btn btn-link showPersonalInfo'data-disposalState = '" + data[10] + "' data-uid='" + data[0] +
                   "' data-loginName='" + data[4] + "' data-userName='" + data[3] +
                   "'data-age='" + data[6] + "' data-sex='" + data[5] + "' data-department='" + data[7] + "' data-cellPhone='" + data[14]
                   + "' data-email='" + data[15] + "' data-warningState='" + data[8] + "' data-amountType='" + data[14] + "' data-testDate = '"
                   + data[9] + "' data-belongToCode='" + data[12] + "' data-testType = '"+data[16]+"'>查看</button>"
                    + " <button class='btn btn-link deleteIdioctoniaEstimate' data-id='57'  data-uid='" + data[0] + "' data-belongToCode='"
                    + data[12] + "' onclick='u_delete(this)'>删除</button>";
                    if (data[8] == "暂无") {
        ...
        $(document).on("click", "[data-mark='addDiscernEstimate']", function () {
        ...
        $(document).on("click", ".showPersonalInfo", function () {
            ...
            window.location.href = "IdioctoniaEstimateReport.aspx";
        })
        ...
        $(document).on("click", ".deleteIdioctoniaEstimate", function () {
            var belongToCode = $(this).attr("data-belongToCode");
        ...
        $(document).on("click", ".bulkExportExcel", function () {
            var url = "Ajax/IdioctoniaEstimate.ashx?operationType=BulkExportExcel";
